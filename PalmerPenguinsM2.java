...
public class PalmerPenguinsM2 {
    ...
    // constants to represent the number of individuals observed per species
    ...
    public static void main(String[] args) {
        ...
        // output the percentage of each species to total number of penguins
        ...
        System.out.printf("%s:%d(%.2f%%)\n", SP_GENTOO, NUM_GENTOO, ((double)
                          NUM_GENTOO / totalPenguins * 100));
        System.out.printf("%s:%d(%.2f%%)\n", SP_ADELIE, NUM_ADELIE, ((double)
                          NUM_ADELIE / totalPenguins * 100)); 
